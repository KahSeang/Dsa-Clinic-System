    ...
    public static void main(String[] args) {
        ...
        while (true) {
            if (user.getRole().equals("admin")) {
                ...
                System.out.println("6. User Account Management");
                ...
                else if (choice.equals("6")) new UserManagementUI().start();
                else if (choice.equals("7")) new AccountSettingsUI().start(user);
                ...
                else if (choice.equals("3")) new AccountSettingsUI().start(user);
